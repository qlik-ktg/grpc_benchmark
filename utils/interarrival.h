#ifndef SOURCE_DIRECTORY__INTERARRIVAL_H_
#define SOURCE_DIRECTORY__INTERARRIVAL_H_
...
public:
    ...
    void init(const RandomDistInterface& r, int threads,
        ...
        for (int i = 0; i < threads; i++) {
            thread_posns_.push_back(
                    random_table_.begin() + (entries * i) / threads);
        }
    }
...
#endif /* SOURCE_DIRECTORY__INTERARRIVAL_H_ */
